                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            @if (Auth::guard('')->user()->is_sign_up == 0)
                                <h4 class="card-title">اكمال بياناتك الشخصية</h4>
                            @else
                                        ...
                                        <div>
                                            <div class="mb-3">
                                                ...
                                                <input type="file"
                                                        ...
                                                        name="image" required value="{{ old('image') }}" @if(auth()->guard('beneficiaries')->user()->image == null) required @endif>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mt-3 mt-lg-0">
                                            <div class="mb-3">
                                                ...
                                                name="id_image" value="{{ old('id_image') }}"  @if(auth()->guard('beneficiaries')->user()->id_image == null) required @endif>
                                            </div>
                                        </div>
                                    </div>
                                </div>
